...
const tools = {
  ...
  chaos_prepare: chaosPrepareTool,
  chaos_execute: chaosExecuteTool,
  chaos_get_pods: chaosGetPodsTool,
  chaos_get_namespaces: chaosGetNamespacesTool,
  chaos_get_labels: chaosGetLabelsTool,
  chaos_find_pods: chaosFindPodsTool,
} satisfies ToolSet;
